...
let image={} //initialisation de la variable image
...
function affichageImages(){
    ...
    image=base_de_donnees[produit_id].couleur.noir; // on stocke le lien de l'image (c'est l'image noir) dans la variable image
